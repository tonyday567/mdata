...
You can drop your own datasets in ~/.cache/ and it will let you load them next serve.
...
C.writeChartOptions "other/titanic.svg"
...
Each chart is generated by the `multiPlot` function.
